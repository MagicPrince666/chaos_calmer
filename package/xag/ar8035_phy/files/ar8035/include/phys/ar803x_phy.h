...
int ar803x_phy_is_fdx(int unit,int phyUnit);
int ar803x_phy_speed(int unit,int phyUnit);
BOOL ar803x_phy_setup(void  *arg);
BOOL ar803x_phy_is_link_alive(int phyUnit);
...
#define ATHER_LATCH_LINK_PASS                  0x0004 
