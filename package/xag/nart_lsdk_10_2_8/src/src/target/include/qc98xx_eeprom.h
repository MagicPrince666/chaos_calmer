...
#define WHAL_FEATUREENABLE_SMART_ANTENNA_MASK		0x80
#define WHAL_FEATUREENABLE_SMART_ANTENNA_SHIFT		7
...
#define WHAL_BOARD_FLAG1_TX_BURST_MASK          0x20
#define WHAL_BOARD_FLAG1_TX_BURST_SHIFT         5
...
typedef struct qc98xxEepromRateTbl
{
    ...
    CAL_TARGET_POWER_11A_40       targetPower5GVHT40[WHAL_NUM_11A_40_TARGET_POWER_CHANS];       // 72B
    CAL_TARGET_POWER_11A_80       targetPower5GVHT80[WHAL_NUM_11A_80_TARGET_POWER_CHANS];       // 72B
} __ATTRIB_PACK QC98XX_EEPROM_RATETBL;

enum {
    EEEPROM_RATEPOWER_TBL_SET = 0,
    EEEPROM_RATEPOWER_TBL_GET, 
};
