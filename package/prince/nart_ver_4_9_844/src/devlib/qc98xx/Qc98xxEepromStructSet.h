...
extern A_INT32 Qc98xxEnableSmartAntennaSet(int value);
...
extern A_INT32 Qc98xxFlag1TxBurstSet(int value);
...
// The following are for retrieving paprd related parameter.
extern A_INT32 Qc98xxCoarseIndexSet(int value, int iBand);
extern A_INT32 Qc98xxFineIndexSet(int value, int iBand);
extern A_INT32 Qc98xxAdcDesiredSizeSet(int value, int iBand);
extern A_INT32 Qc98xxQuickDropSet(int value, int iBand);
extern A_INT32 Qc98xxMaxRetrainTimesSet(int value, int iBand);
extern A_INT32 Qc98xxSettleTimeSet(int value, int iBand);
extern A_INT32 Qc98xxObdbAux1Aux2Set(int *value, int ix, int iy, int iz, int num, int iBand);
extern A_INT32 Qc98xxObdbAux1Aux2LowSet(int *value, int ix, int iy, int iz, int num, int iBand);
extern A_INT32 Qc98xxObdbAux1Aux2HighSet(int *value, int ix, int iy, int iz, int num, int iBand);
